...
void setup(){
  ...
  //Calibrate the R0 value of the sensor
...
void loop() {
  ...
  MQ8.update();
  MQ9.update();
  //Set up the exponential equation for the gas, the A and B values are PPM = A*ratio^B
  ...
  //Determination of security alarm，Start the LED light and buzzer
...
//Determination of security alarm，displayed on oled screen
void detection(){
    u8g2.clearBuffer();
